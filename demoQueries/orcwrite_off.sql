...
DROP TABLE IF EXISTS store_returns_orc;
create table store_returns_orc
(
...
stored as orc;
insert into table store_returns_orc partition (sr_returned_date) 
...
from tpcds_bin_partitioned_orc_200.store_returns_text sr    where  sr_returned_date is not null;   
